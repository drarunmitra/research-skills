...
This skill drafts and structurally revises the manuscript; hand off the rest of the lifecycle:
- **academic-writer** -- run last to humanize/de-bloat the settled draft. It is the suite's canonical humanizer and verifies citations; this skill's CRITIQUE mode is a quick self-audit, not a substitute for it.
